...
namespace Crest
{
    ...
    /// </summary>
    public class CustomControlledBoat : FloatingObjectBase
    {
        /// <summary>
...
#pragma warning restore 414
        ...
        void FixedUpdate()
        {
            ...
            float rawForward = GetRawForward();
            float forward = _throttleBias + rawForward;
            _rb.AddForceAtPosition(transform.forward * _enginePower * forward, forcePosition, ForceMode.Acceleration);

            float reverseMultiplier = (rawForward < 0f ? -1f : 1f);
            float sideways = _steerBias + GetSideways() * reverseMultiplier;
        ...
        private float GetRawForward() => moveInput.y;

        private float GetSideways() => moveInput.x;

        public void SetMoveInput(Vector2 val) => moveInput = val; 
    }
}
